...
#pragma region INDEX_BUFFER
	...
	// +X
	pIndices[0]._0 = 1; 	pIndices[0]._1 = 4; 	pIndices[0]._2 = 7;
	pIndices[1]._0 = 1;		pIndices[1]._1 = 7;		pIndices[1]._2 = 2;
	
	// -X
	pIndices[2]._0 = 4; 	pIndices[2]._1 = 0; 	pIndices[2]._2 = 7;
	pIndices[3]._0 = 4;		pIndices[3]._1 = 7;		pIndices[3]._2 = 3;
	...
	pIndices[7]._0 = 3;		pIndices[7]._1 = 7;		pIndices[7]._2 = 2;


	// +Z
	pIndices[8]._0 = 4; 	pIndices[8]._1 = 5; 	pIndices[8]._2 = 6;
	pIndices[9]._0 = 4;		pIndices[9]._1 = 6;		pIndices[9]._2 = 7;
