...
HRESULT CGameObject_3D_Static::Set_Component()
{
	...
	if (mComModel == nullptr)
		FAILED_CHECK(__super::Add_Component(LEVEL_STATIC, TAGCOM(COMPONENT_MODEL), TEXT("Com_Texture"), (CComponent**)&mComTexture));
...
HRESULT CGameObject_3D_Static::Set_ConstantTable_World()
{
	return S_OK;
}

HRESULT CGameObject_3D_Static::Set_ConstantTable_Tex(_uint texid)
{
	// 텍스처 넘기기
